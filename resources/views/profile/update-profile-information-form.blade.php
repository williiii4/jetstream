<x-form-section submit="updateProfileInformation">
    <x-slot name="title">
        @lang('dashboard.back_profile_info')
    </x-slot>

    <x-slot name="description">
        @lang('dashboard.back_profile_description')
    </x-slot>
    ...
    <x-slot name="form">
        ...
        @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
            <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 sm:col-span-4">
                ...
                <div class="mt-2 flex" x-show="! photoPreview">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="wallet" type="text" class="mt-1 block w-full" wire:model="state.wallet" autocomplete="wallet" />
            <x-input-error for="wallet" class="mt-2" />
        </div>
