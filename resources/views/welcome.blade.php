                                    ...
                                    <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                        ...
                                        <div class="pt-3 sm:pt-5 lg:pt-0">
                                            <h2 class="text-xl font-semibold text-black dark:text-white">
                                                @lang('dashboard.back_documentation')
                                            </h2>
                                ...
                                <div class="cpg2k cxlmv c6tul c9tob cz1az chzuj">
                                    <div class="cffw7 cwd29">
                                        <div class="cpg2k cp8bu cxlmv c6tul cz1az">
                                            <!-- Logo -->
                                            <a class="cse12 cwrvl cwd29" href="index.html" aria-label="Cruip">
                                                <img src="./images/logo.svg" width="36" height="28" alt="Logo">
                                            </a>
                                            <div class="cx2u1 ceqzt cs04f">Copyright © Cruip<span class="cl3ta c2oao">. All rights reserved.</span></div>
                                        </div>
                                    </div>
                                    <!-- Social links -->
                                    <ul class="cwrvl cx72d">
                                        <li>
                                            <a class="cpg2k c6tul c9tob cy8t1 c71yh cru0k cucov cqql8" href="#0" aria-label="Twitter">
                                                <svg class="c76tx cok1d c5om4" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="m13.063 9 3.495 4.475L20.601 9h2.454l-5.359 5.931L24 23h-4.938l-3.866-4.893L10.771 23H8.316l5.735-6.342L8 9h5.063Zm-.74 1.347h-1.457l8.875 11.232h1.36l-8.778-11.232Z"></path>
                                                </svg>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="cpg2k c6tul c9tob cy8t1 c71yh cru0k cucov cqql8" href="#0" aria-label="YouTube">
                                                <svg class="c76tx cok1d c5om4" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <li>
                                            <a class="cpg2k c6tul c9tob cy8t1 c71yh cru0k cucov cqql8" href="#0" aria-label="Telegram">
                                                <svg class="c76tx cok1d c5om4" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
